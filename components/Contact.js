        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="contact-social-row">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="csocial-btn">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="csocial-btn">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
